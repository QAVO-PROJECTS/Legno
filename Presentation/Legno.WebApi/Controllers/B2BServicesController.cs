...
namespace Legno.WebApi.Controllers
{
    ...
    [ApiController]
    public class B2BServicesController : ControllerBase
    {

        private readonly IB2BServiceService _service;
        public B2BServicesController(IB2BServiceService service) { _service = service; }
