...
namespace Legno.WebApi.Controllers
{
    ...
    [ApiController]
    public class DesignerServicesController : ControllerBase
    {
        private readonly IDesignerServiceService _service;
        public DesignerServicesController(IDesignerServiceService service) { _service = service; }
