...
using Legno.Application.Abstracts.Repositories; // ICommonServiceReadRepository, ICommonServiceWriteRepository

namespace Legno.Persistence.Concreters.Services
{
    public class CommonServiceService : ICommonServiceService
    {
        private readonly ICommonServiceReadRepository _read;
        private readonly ICommonServiceWriteRepository _write;
        private readonly IMapper _mapper;

        public CommonServiceService(
            ICommonServiceReadRepository read,
            ICommonServiceWriteRepository write,
            IMapper mapper)
        {
            _read = read;
            _write = write;
        ...
        public async Task<CommonServiceDto> AddCommonServiceAsync(CreateCommonServiceDto createDto)
        {
            ...
            var entity = _mapper.Map<CommonService>(createDto);
