...
namespace Legno.Persistence.Concreters.Services
{
    ...
    {
        private readonly IWorkPlanningReadRepository _read;
        private readonly IWorkPlanningWriteRepository _write;
        private readonly IMapper _mapper;

        public WorkPlanningService(
            IWorkPlanningReadRepository read,
            IWorkPlanningWriteRepository write,
            IMapper mapper)
        {
            _read = read;
            _write = write;
        ...
        public async Task<CommonServiceDto> AddCommonServiceAsync(CreateCommonServiceDto createDto)
        {
            ...
            var entity = _mapper.Map<WorkPlanning>(createDto);
